...
sampleMetadataBuilder <- function(dataSource) {
    dt <- mbioUtils::getDataFromSource(dataSource, keepIdsAndNumbersOnly=FALSE, cleanColumnNames=TRUE)
    dataColNames <- names(dt)
    recordIdColumn <- mbioUtils::findRecordIdColumn(dataColNames)
    ancestorIdColumns <- mbioUtils::findAncestorIdColumns(dataColNames)
...
setMethod("MbioDataset", signature("Collection", "SampleMetadata", "missing"), function(collections, metadata, ontology) {
    new("MbioDataset", collections = mbioUtils::Collections(collections), metadata = metadata)
})
...
setMethod("MbioDataset", signature("Collection", "data.frame", "missing"), function(collections, metadata, ontology) {
    new("MbioDataset", collections = mbioUtils::Collections(collections), metadata = sampleMetadataBuilder(metadata))
})
...
setMethod("MbioDataset", signature("Collection", "list", "missing"), function(collections, metadata, ontology) {
    new("MbioDataset", collections = mbioUtils::Collections(collections), metadata = sampleMetadataFromDataSources(metadata))
})
...
setMethod("MbioDataset", signature("Collection", "missing", "missing"), function(collections, metadata, ontology) {
    new("MbioDataset", collections = mbioUtils::Collections(collections))
})
...
setMethod("MbioDataset", signature("Collection", "character", "missing"), function(collections, metadata, ontology) {
    new("MbioDataset", collections = mbioUtils::Collections(collections), metadata = sampleMetadataFromDataSources(list(metadata)))
})
...
setMethod("MbioDataset", signature("list", "SampleMetadata", "data.frame"), function(collections, metadata, ontology) {
    new("MbioDataset", collections = mbioUtils::Collections(collections, ontology), metadata = metadata)
})
...
setMethod("MbioDataset", signature("list", "SampleMetadata", "character"), function(collections, metadata, ontology) {
    new("MbioDataset", collections = mbioUtils::Collections(collections, data.table::fread(ontology)), metadata = metadata)
})
...
setMethod("MbioDataset", signature("list", "data.frame", "data.frame"), function(collections, metadata, ontology) {
    new("MbioDataset", collections = mbioUtils::Collections(collections, ontology), metadata = sampleMetadataBuilder(metadata))
})
...
setMethod("MbioDataset", signature("list", "data.frame", "character"), function(collections, metadata, ontology) {
    new("MbioDataset", collections = mbioUtils::Collections(collections, data.table::fread(ontology)), metadata = sampleMetadataBuilder(metadata))
})
...
setMethod("MbioDataset", signature("list", "missing", "data.frame"), function(collections, metadata, ontology) {
    new("MbioDataset", collections = mbioUtils::Collections(collections, ontology), metadata = sampleMetadataFromDataSources(metadata))
})
...
setMethod("MbioDataset", signature("list", "missing", "character"), function(collections, metadata, ontology) {
    new("MbioDataset", collections = mbioUtils::Collections(collections, data.table::fread(ontology)), metadata = sampleMetadataFromDataSources(metadata))
})
...
setMethod("MbioDataset", signature("list", "character", "data.frame"), function(collections, metadata, ontology) {
    new("MbioDataset", collections = mbioUtils::Collections(collections, ontology), metadata = sampleMetadataFromDataSources(list(metadata)))
})
...
setMethod("MbioDataset", signature("list", "character", "character"), function(collections, metadata, ontology) {
    new("MbioDataset", collections = mbioUtils::Collections(collections, data.table::fread(ontology)), metadata = sampleMetadataFromDataSources(list(metadata)))
})
...
setMethod("MbioDataset", signature("data.frame", "missing", "data.frame"), function(collections, metadata, ontology) {
    new("MbioDataset", collections = mbioUtils::Collections(collections, ontology))
})
...
setMethod("MbioDataset", signature("data.frame", "missing", "character"), function(collections, metadata, ontology) {
    new("MbioDataset", collections = mbioUtils::Collections(collections, data.table::fread(ontology)))
})
