...
This app employs correlation analysis between microbial taxonomic abundances and sample metadata 
...
HMP_WGS_species <- getCollection(HMP_WGS, "WGS Species")
...
HMP_WGS_species <- getCollection(HMP_WGS, "WGS Species")
HMP_WGS_pathways <- getCollection(HMP_WGS, "WGS Metagenome enzyme pathway abundance data" )
...
## renders an interactive htmlwidget
correlationNetwork(
  pathway_vs_species,
  correlationCoefThreshold = 0.5,
  pValueThreshold = 0.05,
  bipartiteNetwork = TRUE
)
```
