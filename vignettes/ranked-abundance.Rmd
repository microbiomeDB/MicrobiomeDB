...
metric of interest. Available metrics are `mean`, `median`, `q3` and `variance`.
...
## top 10 taxa by mean relative abundance across all samples
rankedAbund <- rankedAbundance(HMP_WGS_species, method = "mean", cutoff = 10) 
