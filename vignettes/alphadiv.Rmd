...
alphaDivOutput <- alphaDiversity(genus, method = 'shannon')
```
...
## get an alpha diversity ComputeResult
genus <- getCollection(microbiomeData::HMP_WGS, 'WGS Genus')
alphaDivOutput <- alphaDiversity(genus, method = 'simpson')
```
...
## get an alpha diversity ComputeResult
genus <- getCollection(microbiomeData::HMP_WGS, 'WGS Genus')
alphaDivOutput <- alphaDiversity(genus, method = 'evenness')
```
