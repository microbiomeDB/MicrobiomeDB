...
Then, in order to import phyloseq objects, the [mia][] package is also required. Once that is installed (see [above](#introduction)), 
...
Then, in order to import biom files and objects, the [mia][] package is also required. Once that is installed (see [above](#introduction)), 
you can do the following:
...
In order to import QIIME2 output files, the [mia][] package is also required. Once that is installed (see [above](#introduction)), 
you can do the following:
...
In order to import Mother output files, the [mia][] package is also required. Once that is installed (see [above](#introduction)), 
you can do the following:
...
Then, in order to import dada2 output files, the [mia][] package is also required. Once that is installed (see [above](#introduction)), 
you can do the following:
...
In order to import HUMAnN output files, the [mia][] package is also required. Once that is installed (see [above](#introduction)), 
you can do the following:
